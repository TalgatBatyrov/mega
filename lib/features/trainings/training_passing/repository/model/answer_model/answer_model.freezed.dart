...
class _$AnswerModelImpl implements _AnswerModel {
  const _$AnswerModelImpl({required this.id, required this.name});
  ...
  @override
  String toString() {
    return 'AnswerModel(id: $id, name: $name)';
  }
...
abstract class _AnswerModel implements AnswerModel {
  const factory _AnswerModel(
      {required final int id, required final String name}) = _$AnswerModelImpl;
