...
mixin _$MovieState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<MovieModel> movies) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<MovieModel> movies)? success,
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl({required final List<MovieModel> movies})
      : _movies = movies;
...
abstract class _Success implements MovieState {
  const factory _Success({required final List<MovieModel> movies}) =
      _$SuccessImpl;
